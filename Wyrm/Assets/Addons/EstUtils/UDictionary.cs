...
namespace UnityEngine.EstUtils
{
    ...
    public class UDictEventArgs<TKey, TValue> : EventArgs
    {
        ...
        public UDictEventArgs(TKey k, TValue v, TValue oldv, bool isNew)
        {
            Key = k;
            Value = v;
            OldValue = oldv;
    ...
    public class UDictionary<TKey, TValue> : UDictionary, IDictionary<TKey, TValue>
    {
        ...
        public EventHandler<UDictEventArgs<TKey, TValue>> OnChange = delegate {};

        public TValue this[TKey key]
        {
            get => Dictionary.GetValueOrDefault(key, default);
            set
            {
                ...
                OnChange?.Invoke(this, new UDictEventArgs<TKey, TValue>(key, value, oldVal, index < 0));
            }
        }
